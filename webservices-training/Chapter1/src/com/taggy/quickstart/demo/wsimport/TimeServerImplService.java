 ...
 * 
 */
@WebServiceClient(name = "TimeServerImplService", targetNamespace = "http://quickstart.taggy.com/", wsdlLocation = "http://127.0.0.1:8443/TimeMachineService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TIMESERVERIMPLSERVICE_QNAME = new QName("http://quickstart.taggy.com/", "TimeServerImplService");
    ...
    public TimeServer getTimeServerImplPort() {
        return super.getPort(new QName("http://quickstart.taggy.com/", "TimeServerImplPort"), TimeServer.class);
    }
    ...
    public TimeServer getTimeServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://quickstart.taggy.com/", "TimeServerImplPort"), TimeServer.class, features);
    }
