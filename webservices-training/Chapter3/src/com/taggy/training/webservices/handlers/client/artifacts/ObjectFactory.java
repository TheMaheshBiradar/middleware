 ...
 * generated in the com.taggy.training.webservices.handlers.client.artifacts package. 
...
public class ObjectFactory {
    ...
    private final static QName _CountRabbitsResponse_QNAME = new QName("http://quickstart.taggy.com", "countRabbitsResponse");
    private final static QName _CountRabbits_QNAME = new QName("http://quickstart.taggy.com", "countRabbits");
    private final static QName _FibException_QNAME = new QName("http://quickstart.taggy.com", "FibException");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.taggy.training.webservices.handlers.client.artifacts
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://quickstart.taggy.com", name = "countRabbitsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://quickstart.taggy.com", name = "countRabbits")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://quickstart.taggy.com", name = "FibException")
