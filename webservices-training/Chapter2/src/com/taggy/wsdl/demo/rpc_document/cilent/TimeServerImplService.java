 ...
 * 
 */
@WebServiceClient(name = "TimeServerImplService", targetNamespace = "http://rpc_document.demo.wsdl.taggy.com/", wsdlLocation = "http://127.0.0.1:8443/TimeMachineService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TIMESERVERIMPLSERVICE_QNAME = new QName("http://rpc_document.demo.wsdl.taggy.com/", "TimeServerImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8443/TimeMachineService?wsdl");
    ...
    public TimeServer getTimeServerImplPort() {
        return super.getPort(new QName("http://rpc_document.demo.wsdl.taggy.com/", "TimeServerImplPort"), TimeServer.class);
    }
    ...
    public TimeServer getTimeServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://rpc_document.demo.wsdl.taggy.com/", "TimeServerImplPort"), TimeServer.class, features);
    }
