 ...
 * generated in the com.taggy.wsdl.demo.rpc_document.cilent package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTimeAsElapsedResponse_QNAME = new QName("http://rpc_document.demo.wsdl.taggy.com/", "getTimeAsElapsedResponse");
    private final static QName _GetTimeAsElapsed_QNAME = new QName("http://rpc_document.demo.wsdl.taggy.com/", "getTimeAsElapsed");
    private final static QName _GetTimeAsStringResponse_QNAME = new QName("http://rpc_document.demo.wsdl.taggy.com/", "getTimeAsStringResponse");
    private final static QName _GetTimeAsString_QNAME = new QName("http://rpc_document.demo.wsdl.taggy.com/", "getTimeAsString");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.taggy.wsdl.demo.rpc_document.cilent
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rpc_document.demo.wsdl.taggy.com/", name = "getTimeAsElapsedResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rpc_document.demo.wsdl.taggy.com/", name = "getTimeAsElapsed")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rpc_document.demo.wsdl.taggy.com/", name = "getTimeAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rpc_document.demo.wsdl.taggy.com/", name = "getTimeAsString")
